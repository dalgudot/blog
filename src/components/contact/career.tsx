...
const careerData = [
  ...
  },
  {
    ...
    contents: [
      {
        term: '2022.03.16 ~ 현재',
        text: "많은 기능과 서비스를 갖추고 있는 슈퍼 앱들 사이에서 단순함을 가장 큰 목표로 하는 '작은 앱'이 사람들에게 어떠한 의미로 다가가는지, 단순함은 더 좋은 UX를 제공할 가능성이 높은지 연구하는 '작은 앱 프로젝트'를 진행하고 있습니다. 현재 윤슬, 오늘 할 일, 식물 가족 iOS 앱을 운영하고 있습니다.",
      },
      {
        term: '2022.01.01 ~ 현재',
        text: "디자인과 개발 경험을 기록하고 공유하는 '경험의 기록' 블로그를 운영하고 있습니다. 블로그를 위한 WYSIWYG 에디터를 개발했습니다.",
      },
      {
